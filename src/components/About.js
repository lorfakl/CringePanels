        ...
        <div className="hero bg-base-200 min-h-screen">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p className="py-6">
                        I am Kaleb Jahad, the main host of any Anti-Cringe Panel Production. I have a team of helpers that I would be utterly ineffectual without but they dont want to be on this page.
